...
export function Button({children, variant = 'primary', icon: Icon, onClick, disabled}: ButtonProps) {
    const baseStyles = "px-4 py-2 rounded-lg font-medium transition-all hover:shadow-md shadow-shadow disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 cursor-pointer";
