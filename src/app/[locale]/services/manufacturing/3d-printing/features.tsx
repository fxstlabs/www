...
export default function TDPrintingFeatures() {
    const t = useTranslations("services.manufacturing.3d-printing.about")

    const features = [
        {
            name: t("features.material.title"),
            description: t("features.material.description"),
            icon: Layers,
            gradient: "from-cyan-500 to-blue-500"
        },
        {
            name: t("features.geometry.title"),
            description: t("features.geometry.description"),
            icon: Zap,
            gradient: "from-emerald-500 to-cyan-500"
        },
        {
            name: t("features.speed.title"),
            description: t("features.speed.description"),
            icon: CheckCircle,
            gradient: "from-pink-500 to-purple-500"
        },
        {
            name: t("features.quality.title"),
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16 lg:py-20 min-h-screen flex items-center">
                ...
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-center w-full">
                    ...
                    <div
                        ...
                        <img
                            src={fxstCdn('static/images/pages/services/manufacturing/3d-printing/creality-printer-with-prints.jpg')}
